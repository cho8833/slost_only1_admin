            ...
            if (snapshot.hasData) {
              ...
              return Column(
                ...
                children: [
                  ...
                  _Column(
                      title: "선생님이 된 계기", value: data.howBecameTeacher ?? ""),
                  _Column(
                      title: "자신있는 연령",
                  ...
                  _Column(
                      ...
                      value: data.availableCategory
                              ...
                              .join(", ") ??
                          ""),
                  _Column(title: "상태", value: data.status.title),
                  const SizedBox(
                    height: 32,
                  ),
                  Row(
                    children: [
                      StatusBuilder(
                          statusNotifier: teacherProvider.setStatusStatus,
                          idleBuilder: (context) {
                          ...
                          idleBuilder: (context) {
                            return ButtonTemplate(
                                ...
                                onTap: () {
                                  teacherProvider
                                      .setStatus(data.id,
                                          TeacherProfileStatus.rejected)
                                      .then((_) {
                                    setState(() {}); // reload teacher profile detail
                                  }).catchError((e) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(content: Text(e.toString())));
                                  });
